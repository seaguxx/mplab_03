...
# 52 "mcc_generated_files/i2c1.c" 2
...
static __attribute__((inline)) void wait4Start(void)
{
...
static __attribute__((inline)) void wait4BusFree(void)
{
    uint8_t waitCount = 255;
    if(lastError == I2C1_GOOD)
    {
...
static __attribute__((inline)) void sendByte(uint8_t data)
{
...
static __attribute__((inline)) uint8_t receiveByte(void)
{
    uint8_t delayCounter = 255;
    if(lastError == I2C1_GOOD)
    {
...
static __attribute__((inline)) void wait4Stop(void)
{
    uint8_t waitCount = 255;
    if(lastError == I2C1_GOOD)
    {
...
static __attribute__((inline)) void wait4MDRSetcount(uint8_t count)
{
    uint8_t waitCount = 255;
    if(lastError == I2C1_GOOD)
    {
