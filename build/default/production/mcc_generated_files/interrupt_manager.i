...
# 96 "mcc_generated_files/ecan.h"
void ECAN_ISR_ECAN_RXB0I(void);
# 119 "mcc_generated_files/ecan.h"
void ECAN_Initialize(void);
# 141 "mcc_generated_files/ecan.h"
void CAN_sleep(void);
# 162 "mcc_generated_files/ecan.h"
uint8_t CAN_transmit(uCAN_MSG *tempCanMsg);
# 186 "mcc_generated_files/ecan.h"
uint8_t CAN_receive(uCAN_MSG *tempCanMsg);
# 208 "mcc_generated_files/ecan.h"
uint8_t CAN_messagesInBuffer(void);
# 232 "mcc_generated_files/ecan.h"
uint8_t CAN_isBusOff(void);
# 256 "mcc_generated_files/ecan.h"
uint8_t CAN_isRXErrorPassive(void);
# 280 "mcc_generated_files/ecan.h"
...
void __attribute__((picinterrupt(("")))) INTERRUPT_InterruptManager (void)
{
    ...
    else if(PIE4bits.INT1IE == 1 && PIR4bits.INT1IF == 1)
    {
        INT1_ISR();
    }
    ...
    else if(PIE8bits.INT2IE == 1 && PIR8bits.INT2IF == 1)
    {
        INT2_ISR();
    }
    else
